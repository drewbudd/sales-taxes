...
describe('calculateTax', () => {
  test.each([
    ...
    { inputCost: 0.24, basicSalesTax: true, importSalesTax: false, expected: 0.05 },
    { inputCost: 0.51, basicSalesTax: true, importSalesTax: false, expected: 0.10 },
    ...
    { inputCost: 0.49, basicSalesTax: false, importSalesTax: true, expected: 0.05 },
    { inputCost: 1.01, basicSalesTax: false, importSalesTax: true, expected: 0.10 },
    { inputCost: 10.33, basicSalesTax: false, importSalesTax: true, expected: 0.55 },
    { inputCost: 1.00, basicSalesTax: true, importSalesTax: true, expected: 0.15 },
    { inputCost: 0.16, basicSalesTax: true, importSalesTax: true, expected: 0.05 },
    { inputCost: 0.34, basicSalesTax: true, importSalesTax: true, expected: 0.10 },
    ...
    { inputCost: 11.25, basicSalesTax: false, importSalesTax: true, expected: 0.60 }, // imported chocolates
